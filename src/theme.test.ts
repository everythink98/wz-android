...
describe('Android reader theme helpers', () => {
  ...
  it('keeps reply action rows single-line with compact tappable buttons', () => {
    ...
    expect(styles.replyCompactActionButton.width).toBeUndefined();
    expect(styles.replyCompactActionButton.justifyContent).toBe('flex-start');
    expect(styles.replyCompactActionIconSlot.width).toBeLessThan(styles.detailActionIconSlot.width as number);
    expect(styles.detailActionCompactLabel.fontSize).toBeLessThan(styles.detailActionLabel.fontSize as number);
    expect(styles.detailActionCompactCount.fontSize).toBeLessThan(styles.detailActionCount.fontSize as number);
    expect(styles.detailActionCompactTextBlock.gap).toBeLessThanOrEqual(2);
