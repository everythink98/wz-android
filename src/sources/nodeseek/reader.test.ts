...
describe('NodeSeek reader', () => {
  ...
  it('[REG-TOPIC-128] assigns NodeSeek polls to their content owner and normalizes reply markers in place', async () => {
  ...
  it('[REG-TOPIC-128] leaves code and href-only vote markers inert without fetching fake polls', async () => {
