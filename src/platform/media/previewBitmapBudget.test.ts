...
describe('preview bitmap budget', () => {
  it('caps a high-density phone viewport before native image decode', () => {
  ...
  ])('bounds invalid viewport input %#', ({ height, pixelRatio, width }) => {
  ...
  it('preserves request identity while adding the native decode target', () => {
    const source = {
  ...
  it('reaches original 1:1 pixels without the old fixed 8x ceiling', () => {
  ...
  it('falls back safely when 1:1 scale inputs are invalid', () => {
