...
export function DiscourseFilterPickers({
  ...
  return (
    <>
      <Modal transparent visible={tags.visible} animationType="fade" onRequestClose={tags.close}>
      ...
      <Modal transparent visible={category.visible} animationType="fade" onRequestClose={category.close}>
        <KeyboardAvoidingView behavior="height" style={styles.searchFilterModalRoot}>
          <Pressable
            accessibilityRole="button"
      ...
      <Modal transparent visible={users.visible} animationType="fade" onRequestClose={users.close}>
        <KeyboardAvoidingView behavior="height" style={styles.searchFilterModalRoot}>
          <Pressable
            accessibilityRole="button"
