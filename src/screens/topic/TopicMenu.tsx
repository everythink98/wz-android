  ...
  return (
    <Modal transparent visible={visible} animationType="fade" onRequestClose={onRequestClose}>
      <View style={styles.topicMenuLayer}>
        <Pressable accessibilityRole="button" accessibilityLabel="关闭更多操作" style={styles.topicMenuDismissLayer} onPress={onRequestClose} />
        <View style={styles.topicOverflowMenu}>
          ...
          <Pressable accessibilityRole="menuitem" android_ripple={{ color: theme.primarySoft }} style={[styles.topicMenuItem, styles.topicMenuItemLast]} onPress={() => runTopicMenuAction(() => onOpenOriginal(topicUrl))}>
