...
import { diagnosticRef } from './diagnostics';
...
describe('Android HTML image preview helpers', () => {
  ...
  it('selects density srcset candidates and falls back from unreliable candidate sets', () => {
    expect(selectImageDisplaySource({
      src: 'https://cdn.example.com/fallback.jpg',
      srcset: 'https://cdn.example.com/1x.jpg 1x, https://cdn.example.com/2x.jpg 2x, https://cdn.example.com/3x.jpg 3x'
    }, 300, 2.5)?.uri).toBe('https://cdn.example.com/3x.jpg');
    ...
    }, 300, 2)?.uri).toBe('https://cdn.example.com/fallback.jpg');
  });
  ...
  it('uses lazy attributes for the body only when src is absent or a known placeholder', () => {
    ...
    }, 300, 2)?.uri).toBe('https://cdn.example.com/thumb.jpg');
    ...
    expect(selectImageDisplaySource({
      ...
      'data-original': 'https://cdn.example.com/original.jpg'
    }, 300, 2)?.uri).toBe('https://cdn.example.com/original.jpg');

    const lazyHtml = '<img src="https://cdn.example.com/transparent.gif" data-src="https://cdn.example.com/lazy.jpg" data-original="https://cdn.example.com/original.jpg">';
    ...
    }, 300, 2)?.candidateKind).toBe('data-src');
  ...
  it('prefers original lightbox image URLs over optimized inline image URLs', () => {
    ...
    expect(imagePreviewListFromCatalog(createImagePreviewCatalog([html], 300, 2), 'https://cdn.example.com/optimized.png', null)).toEqual({
      contentSource: null,
      items: [{
        displayUri: 'https://cdn.example.com/optimized.png',
        originalUri: 'https://cdn.example.com/original.png'
  ...
  it('reuses the responsive body candidate that was actually tapped as the preview placeholder', () => {
    const html = '<a class="lightbox" href="https://cdn.example.com/original.png"><img src="https://cdn.example.com/fallback.png" srcset="https://cdn.example.com/320.png 320w, https://cdn.example.com/640.png 640w"></a>';

    expect(imagePreviewListFromCatalog(
      createImagePreviewCatalog([html], 300, 2),
      'https://cdn.example.com/640.png',
      null,
  ...
  it('builds a de-duplicated preview list and keeps tapped image position', () => {
    const result = imagePreviewListFromCatalog(createImagePreviewCatalog([
      ...
      ], 300, 2), 'https://cdn.example.com/b.png', 'linuxdo');
  ...
  it('keeps forum emoji images out of the preview gallery', () => {
    ...
    expect(imagePreviewListFromCatalog(createImagePreviewCatalog([html], 300, 2), 'https://cdn.example.com/photo.jpg', null)).toEqual({
      contentSource: null,
  ...
  it('keeps generic dimension-only tiny images previewable because size alone is not an emoji signal', () => {
    ...
    expect(imagePreviewListFromCatalog(createImagePreviewCatalog([html], 300, 2), 'https://i.imgur.com/2ejt2Q6.png', null)).toEqual({
      contentSource: null,
      items: [
        {
  ...
  it('keeps tiny V2EX embedded images inline after their size is known', () => {
    ...
    expect(result).toContain('<forum-inline-image src="https://i.imgur.com/agAJ0Rd.png" class="embedded_image" width="20" height="20">');
    expect(result).toContain('<img alt="" class="embedded_image" src="https://i.imgur.com/2ejt2Q6.png" width="2198" height="912">');
  ...
  it('keeps real HTML images previewable even when their URLs have no file extension', () => {
    const result = imagePreviewListFromCatalog(createImagePreviewCatalog([
      ...
      ], 300, 2), 'https://www.nodeseek.com/api/attachments/123', 'nodeseek');
