...
type HtmlAllowedStyles = NonNullable<HtmlProps['allowedStyles']>;
type HtmlBaseStyle = NonNullable<HtmlProps['baseStyle']>;
type HtmlClassesStyles = NonNullable<HtmlProps['classesStyles']>;
type HtmlIgnoredStyles = NonNullable<HtmlProps['ignoredStyles']>;
type HtmlTagsStyles = NonNullable<HtmlProps['tagsStyles']>;
