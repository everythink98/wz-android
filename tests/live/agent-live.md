...
- 能力：`TOPIC-01/02/03`、`MORE-03`；共享 `NAV-02/03`。仅在 targeted 包含 `REG-TOPIC-084/085/086/087/088/089/090/094/097/123/134/135/136/137/138/139/140` 时执行；目标均使用 `exp+wz-android://open-topic?url=<encoded URL>` 直达，不经过搜索或相似帖子。
...
- `REG-TOPIC-137/138`：只读直达 `https://www.yaohuo.me/bbs-1577052.html`，不用评论搜索，按原帖顺序滚到第 2 楼和第 2 页 13 楼；第 2 楼同源 `/face/狂踩.gif` 保持自然比例且最长边不超过 100，第 13 楼外链 GIF 必须紧跟句尾、成功显示为自然 30×30，不得换行、居中、缩成 Emoji 或空白消失。再从 App“更多”进入幺火原站并打开同一链接，只读核对两处 HTML 锚点和原站显示；不以 `.ubbimg`、GIF 后缀或评论角色推断语义，不发帖、不回复、不互动。
